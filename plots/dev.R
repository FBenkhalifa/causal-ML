...
ggsave(race_means, filename = 'presentation/race_means.pdf', width = 30, height = 20, units = 'cm')
...
ggsave(race_z_scores, filename = 'presentation/race_z_scores.pdf', width = 30, height = 20, units = 'cm')
