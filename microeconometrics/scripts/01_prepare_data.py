...
def impute_data(df: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
...
def prepare_data(path: str = "data/data_group_1.csv") -> pd.DataFrame:
    """
...
def print_variable_summaries_latex(data_prepared: str) -> pd.DataFrame:
    """
